...
It is based on https://github.com/Patrick762/hassio-bluetti-bt.git with suppoort for the Bluetti AC180
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=wisebear-nf&repository=hassio-bluetti-bt&category=integration)
...
- AC70 (basic data)
- AC70P (untested)
- AC180 (tested) <-- this reposiotory add support for this
- AC180P (tested)
- AC200L (untested)
- AC200M
- AC300 (tested)
